...
CREATE UNIQUE INDEX review_pages_review_id_page_number_section_number_key ON public.review_pages USING btree (review_id, page_number, section_number);
...
alter table "public"."review_pages" add constraint "review_pages_review_id_page_number_section_number_key" UNIQUE using index "review_pages_review_id_page_number_section_number_key";

alter table "public"."review_pages" add constraint "review_pages_section_number_check" CHECK (((section_number >= 1) AND (section_number <= 3))) not valid;

alter table "public"."review_pages" validate constraint "review_pages_section_number_check";
